...
#include "MonsterController_Boss_First.h"
...
AMonsterController_Boss_First::AMonsterController_Boss_First()
{
	...
	static ConstructorHelpers::FObjectFinder<UBehaviorTree> BTObject(TEXT("BehaviorTree'/Game/LSH/BB_BT/BT_FirstBoss.BT_FirstBoss'"));
...
void AMonsterController_Boss_First::BeginPlay()
{
	Super::BeginPlay();
