...
#include "MonsterNormal_CT_CombatComponent.h"
...
UMonsterNormal_CT_CombatComponent::UMonsterNormal_CT_CombatComponent()
{
	PrimaryComponentTick.bCanEverTick = true;

}

void UMonsterNormal_CT_CombatComponent::BeginPlay()
{
	Super::BeginPlay();

}

void UMonsterNormal_CT_CombatComponent::TakeDamage(AActor* _damagedActor, float _damage, const UDamageType* _damageType, AController* _instigatedBy, AActor* _damageCauser)
{
...
void UMonsterNormal_CT_CombatComponent::Attack(EAI_MeleeAttack_State _state)
{
	Super::Attack(_state);
...
void UMonsterNormal_CT_CombatComponent::MeleeAttackGroup_1()
{
...
void UMonsterNormal_CT_CombatComponent::MeleeAttackGroup_2()
{
...
void UMonsterNormal_CT_CombatComponent::AttackBlock()
{
	Super::AttackBlock();
...
void UMonsterNormal_CT_CombatComponent::SpecialSkill()
{
	Super::SpecialSkill();
...
void UMonsterNormal_CT_CombatComponent::LookAround(bool _stop)
{
	if (_stop)
...
void UMonsterNormal_CT_CombatComponent::SpawnSlashProjectile()
{
