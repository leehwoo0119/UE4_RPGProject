...
#include "MonsterNormal_TS_CombatComponent.generated.h"


UCLASS()
class LSH_API UMonsterNormal_TS_CombatComponent : public UMonsterNormalCombatComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UMonsterNormal_TS_CombatComponent();
